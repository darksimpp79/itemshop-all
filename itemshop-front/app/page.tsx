  ...
  const pricing = [
    {
      ...
      features: ["1 sklep", "1 tryb gry", "Motyw Osadnik", "Plugin MC", "Support Discord"],
      locked: ["Promo kody", "Lootbox", "Motywy Premium", "Własna domena"],
    ...
    },
    {
      ...
      price: "19.99",
      period: "30 dni",
      desc: "Dla małych serwerów",
      features: ["3 sklepy", "3 tryby gry", "Motywy dark, forest", "Promo kody", "Lootbox", "Plugin MC"],
      locked: ["Własna domena"],
      cta: "Aktywuj Starter",
      highlight: false,
    },
    {
      ...
      features: ["Nielimitowane sklepy", "Nielimitowane tryby", "Wszystkie motywy", "Własna domena", "Promo kody", "Lootbox", "Eksport CSV"],
      locked: [],
      cta: "Aktywuj Pro",
      highlight: true,
    },
